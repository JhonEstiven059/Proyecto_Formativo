...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdHabitacion).HasName("PK__Habitaci__8BBBF9012702BF6A");
        ...
        {
            entity.HasKey(e => e.IdHuesped).HasName("PK__Huespede__939EC061E18B84EB");
        ...
        {
            entity.HasKey(e => e.IdPaquete).HasName("PK__Paquetes__DE278F8BDC1A7FC5");
        ...
        {
            entity.HasKey(e => e.IdPermiso).HasName("PK__Permisos__0D626EC8795DCED4");
        ...
        {
            entity.HasKey(e => e.IdReserva).HasName("PK__Reservas__0E49C69DF331333A");
        ...
        {
            entity.HasKey(e => e.IdReservaPaquete).HasName("PK__Reservas__BF8B0A63BF9D4176");
        ...
        {
            entity.HasKey(e => e.IdReservaServicio).HasName("PK__Reservas__B3FBC7477857F842");
        ...
        {
            entity.HasKey(e => e.IdRolPermiso).HasName("PK__Rol_Perm__0CC73B1B59ED829E");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Roles__2A49584C0FADCB62");
        ...
        {
            entity.HasKey(e => e.IdServicio).HasName("PK__Servicio__2DCCF9A27666A8B0");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuarios__5B65BF97DF145F3B");
